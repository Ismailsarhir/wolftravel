<?php
/**
 * Admin Settings Page for Archive Circuits
 * 
...
/**
 * Classe pour gérer la page d'administration de l'archive des circuits
 */
class ArchiveCircuitsSettings {
	 ...
	 * @var string
	 */
	private const OPTION_GROUP = 'tm_archive_circuits_settings';
	 ...
	 * @var string
	 */
	private const PAGE_SLUG = 'tm-archive-circuits';
	 ...
	 * @var string
	 */
	private const OPTION_ARCHIVE_IMAGE = 'tm_archive_circuits_image';
	 ...
	 * @var string
	 */
	private const OPTION_ARCHIVE_TITLE = 'tm_archive_circuits_title';
	 ...
	 * @var string
	 */
	private const OPTION_ARCHIVE_SUBTITLE = 'tm_archive_circuits_subtitle';
	...
	public function enqueue_scripts( string $hook_suffix ): void {
		...
		$expected_hook = 'circuits_page_' . self::PAGE_SLUG;
		...
		\wp_enqueue_script(
			'tm-archive-circuits-admin',
			TM_THEME_URI . '/assets/js/admin-archive-circuits.js',
			[ 'jquery' ],
			TM_VERSION,
			true
		);
	...
	/**
	 * Ajoute la page d'administration comme sous-menu de Circuits
	 * 
	 * @return void
	 */
	public function add_admin_page(): void {
		// Ajoute comme sous-menu du post type "circuits"
		\add_submenu_page(
			'edit.php?post_type=circuits', // Parent: menu Circuits
			\__( 'Archive Circuits', 'transfertmarrakech' ), // Page title
			\__( 'Archive Circuits', 'transfertmarrakech' ), // Menu title
			'manage_options', // Capability
			self::PAGE_SLUG, // Menu slug
			[ $this, 'render_page' ], // Callback
			20 // Position (après "Tous les circuits" et "Ajouter")
		);
	}
	...
	public function register_settings(): void {
		...
		\register_setting(
			...
			[
				...
				'default'           => \__( 'Tous nos circuits', 'transfertmarrakech' ),
			]
		);
	...
	public function render_page(): void {
		...
		\settings_errors( 'tm_archive_circuits_messages' );
		?>
		<div class="wrap">
	...
	public static function get_archive_title(): string {
		return \get_option( self::OPTION_ARCHIVE_TITLE, \__( 'Tous nos circuits', 'transfertmarrakech' ) );
	}
